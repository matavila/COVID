...
"""
    ...
    Criando agora a parte de deploy no share.steamlite.io vamos fazer o seguinte
        . Entrar no site
        . Fazer o vínculo com a conta do githun
        . Adicionar uma novo deploy
        . Colocar o caminho da pasta
            matavila/COVID
        . Colocar o arquivo a ser feito deploy
            CodigoBase.py
    
    OBS: Criar um arquivo limpo sem comentários, pois o steamlite não reconhece comentário e vai colocar tudo no app browser
